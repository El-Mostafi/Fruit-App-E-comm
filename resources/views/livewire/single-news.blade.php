				...
				<div class="col-lg-4">
					<div class="sidebar-section">
						<div class="recent-posts">
							<h4>Recent Posts</h4>
							<ul>
								<li><a href="{{route('single_news')}}">You will vainly look for fruit on it in autumn.</a></li>
								<li><a href="{{route('single_news')}}">A man's worth has its season, like tomato.</a></li>
								<li><a href="{{route('single_news')}}">Good thoughts bear good fresh juicy fruit.</a></li>
								<li><a href="{{route('single_news')}}">Fall in love with the fresh orange</a></li>
								<li><a href="{{route('single_news')}}">Why the berries always look delecious</a></li>
							</ul>
						</div>
						<div class="archive-posts">
							<h4>Archive Posts</h4>
							<ul>
								<li><a href="{{route('single_news')}}">JAN 2019 (5)</a></li>
								<li><a href="{{route('single_news')}}">FEB 2019 (3)</a></li>
								<li><a href="{{route('single_news')}}">MAY 2019 (4)</a></li>
								<li><a href="{{route('single_news')}}">SEP 2019 (4)</a></li>
								<li><a href="{{route('single_news')}}">DEC 2019 (3)</a></li>
							</ul>
						</div>
						<div class="tag-section">
							<h4>Tags</h4>
							<ul>
								<li><a href="{{route('single_news')}}">Apple</a></li>
								<li><a href="{{route('single_news')}}">Strawberry</a></li>
								<li><a href="{{route('single_news')}}">BErry</a></li>
								<li><a href="{{route('single_news')}}">Orange</a></li>
								<li><a href="{{route('single_news')}}">Lemon</a></li>
								<li><a href="{{route('single_news')}}">Banana</a></li>
							</ul>
						</div>
					</div>
				</div>
